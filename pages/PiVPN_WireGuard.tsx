...
export default function PiPVN_WireGuard() {
  return (
    <>
      <Navbar />
      ...
      <main>
        ...
        <ul>
          ...
          <li>
            <a href="#tutorial-im-following">Tutorial I'm Following</a>
          </li>
          <li>
            <a href="#materials-and-software">Materials and Software</a>
          </li>
          <li>
            <a href="#step-by-step">Step by step</a>
            <ul>
              <li>
                <a href="#installing-and-updating-raspberry-pi-os">
                  Installing and updating Raspberry Pi OS
                </a>
              </li>
              <li>
                <a href="#installing-pivpn-and-wireguard">
              ...
              <li>
                <a href="#network-port-forwarding">Network Port Forwarding</a>
              </li>
              <li>
                <a href="#network-change">Network Change</a>
              </li>
              <li>
                <a href="#setting-static-ip-address">
                  Setting static ip address
                </a>{" "}
                -{" "}
                <a href="#-before-setting-static-ip-address-">
                  ~~ Before setting static ip address ~~
                </a>{" "}
                -{" "}
                <a href="#-after-setting-static-ip-address-">
                  ~~ After setting static ip address ~~
                </a>{" "}
                -{" "}
                <a href="#-what-the-eero-app-looks-like-">
                  ~~ What the eero app looks like ~~
                </a>
              </li>
              <li>
                <a href="#port-forwarding">Port Forwarding</a> -{" "}
                <a href="#-what-the-eero-app-looks-like--1">
                  ~~ What the eero app looks like ~~
                </a>
              </li>
              <li>
                <a href="#adding-client--profile-to-vpn-server">
                  Adding client / Profile to VPN server
                </a>
              </li>
              <li>
                <a href="#setting-up-client">Setting Up Client</a>
                <ul>
                  <li>
                    <a href="#phone--tablet">Phone / Tablet</a>
                  </li>
                  <li>
                    <a href="#laptop--desktop">Laptop / Desktop</a>
                  </li>
                </ul>
              </li>
            </ul>
          ...
          <li>
            <a href="#performance-and-conclusion">Performance and Conclusion</a>
          </li>
        </ul>
        ...
        <pre>
          <code class="language-Bash">pivpn -qr</code>
        </pre>
        <p>
